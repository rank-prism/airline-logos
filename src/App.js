    ...
    return (
      <div className="App">
        ...
        <div>
          ...
          <span style={this.state.tempSolUrlValid ? {} : {color: 'red'}}>Serko Online Url: </span><input type="text" size="50" onChange={this.handleSolUrlChange} onBlur={this.updateSolUrl} value={this.state.solUrlTemp}/>
